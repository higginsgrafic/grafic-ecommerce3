...
export default function FullWideSlideDemoColorStripeButtons({
  megaTileSize,
  selectedColorOrder,
  selectedColorSlug,
  onSelect,
  ...
  return (
    <div className="absolute left-0 top-0 z-[40]" style={{ height: `${megaTileSize}px`, pointerEvents: 'auto' }}>
      {items.map((slug, idx) => {
        ...
        return (
          ...
          >
            <div className="absolute inset-0 transition-shadow duration-150 ease-out" style={{ pointerEvents: 'none' }}>
              {isSelected ? (
                <div
                  aria-hidden="true"
            ...
            {isFirst ? (
              ...
              <>
                <button
                  ...
                  style={{
                    left: `${globalOffsetXPx}px`,
                    top: `${globalOffsetYPx}px`,
                    width: `${bodyW}px`,
                    height: '100%',
                    pointerEvents: 'auto',
                  }}
                ...
                {Array.from({ length: steps }).map((_, sIdx) => {
                  ...
                  return (
                    <button
                      ...
                      className="absolute bg-transparent"
                      style={{
                        left: `${x + globalOffsetXPx}px`,
                        top: `${top + globalOffsetYPx}px`,
                        width: `${w}px`,
                        height: `${h}px`,
                        pointerEvents: 'auto',
                      }}
